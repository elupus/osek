...
# Compiler invocation.
#
SET (CMAKE_C_COMPILE_OBJECT 			"${HC12_PIPER} ${CMAKE_C_COMPILER} <DEFINES> <FLAGS> -ObjN=<OBJECT> -EnvERRORFILE=${HC12_ERR_OUTPUT_DIR}/%n.err -Lasm=${HC12_LST_OUTPUT_DIR}/%n.lst <SOURCE>")
SET (CMAKE_CXX_COMPILE_OBJECT 			"${HC12_PIPER} ${CMAKE_CXX_COMPILER} <DEFINES> <FLAGS> -ObjN=<OBJECT> -EnvERRORFILE=${HC12_ERR_OUTPUT_DIR}/%n.err -Lasm=${HC12_LST_OUTPUT_DIR}/%n.lst <SOURCE>")
